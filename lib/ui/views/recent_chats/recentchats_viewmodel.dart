...
class RecentChatsViewModel extends StreamViewModel<QuerySnapshot> {
      ...
      for (var contact in _contacts!) {
        ...
        if (phones != null && phones.isNotEmpty) {
          ...
          for (var phone in mergedPhones) {
            ...
            String? callingCode = _extractCountryCode(number);
            String formattedNumber = _numberFormatter(number);
            String key = formattedNumber;
            log.wtf('countryCode:$callingCode');
            Map<String, dynamic> value = {
              ...
              PhoneNumberField.countryCode:
                  callingCode ?? currentFireUser.countryPhoneCode,
            };
            log.wtf('Value:$value');
  ...
  String? _extractCountryCode(String phone) {
    ...
    Iterable<RegExpMatch> matches = exp.allMatches(phone);

    if (matches.isNotEmpty) {
      final match = matches.first;

      String phoneNumber = phone.substring(match.start, match.end);
      return phoneNumber;
