...
class RecentChatsViewModel extends StreamViewModel<QuerySnapshot> {
  ...
  Future<QuerySnapshot> getUserByInterests(List<String> interests) async {
    setBusy(true);
    final interestedUserList = await _firestore
        .collection(usersFirestoreKey)
        .where(UserField.id, isNotEqualTo: FirestoreApi.liveUserUid)
    ...
    await Future.wait(interestedUserList.docs.map((doc) {
      ...
      if (firebaseDoc.id != FirestoreApi.liveUserUid) {
