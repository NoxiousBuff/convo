...
class InvitesViewModel extends BaseViewModel {
  ...
  Future<bool> _requestContactsPermission() async {
    return _permissionService.requestContactsPermission(Permission.contacts);
  }
          ...
          if (phones != null && phones.isNotEmpty) {
            for (var phone in phones) {
              ...
              if (value != null) {
                ...
                log.wtf(_contact);
                await hiveApi.save(HiveApi.userContacts, key, _contact);
              }
            }
          }
        }
  ...
  String extractCode(String number) {
    try {
      ...
      String code = hiveApi.getUserData(FireUserField.countryPhoneCode);
      return code;
    }
  }
