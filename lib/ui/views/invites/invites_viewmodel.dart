...
class InvitesViewModel extends BaseViewModel {
  ...
  bool _showReachIcon = false;
  bool get showReachIcon => _showReachIcon;

  IconData _reachIcon = FeatherIcons.arrowDown;
  IconData get reachIcon => _reachIcon;
  ...
  void changeReachboolValue(bool value) {
    _showReachIcon = value;
    notifyListeners();
  }

  void changeReachIcon(IconData icon) {
    _reachIcon = icon;
    notifyListeners();
  }
            ...
            for (var phone in phones) {
              ...
              if (value != null) {
                ...
                Map<String, dynamic> _contact = {
                  FireUserField.countryPhoneCode: code,
                  FireUserField.phone: number,
                  FireUserField.displayName: contact.displayName,
                  'ExistsInApp': false,
                };
                log.wtf(_contact);
                await hiveApi.saveInHive(HiveApi.userContacts, key, _contact);
              }
            }
          }
        }
  ...
  String extractCode(String number) {
    try {
      ...
      String code = hiveApi.getUserDataWithHive(FireUserField.countryPhoneCode);
      return code;
    }
  }
