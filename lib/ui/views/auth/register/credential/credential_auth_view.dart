            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  validator: (value) {
                    if (value!.isEmpty) {
                      return customSnackbars.errorSnackbar(context, title: 'Email address can not be empty!!');
                    } else if (!isEmail(value)) {
                      return customSnackbars.errorSnackbar(context, title: 'Provide a valid email address');
                    } else if (value.length < 8) {
                      return customSnackbars.errorSnackbar(context, title: 'Must be at least 8 characters');
                    } else {
                      return null;
                    }
                  },
                ...
                TextFormField(
                  validator: (value) {
                    if (value!.isEmpty) {
                      return customSnackbars.errorSnackbar(context, title: 'Password can not be empty.');
                    } else if (value.length < 8) {
                      return customSnackbars.errorSnackbar(context, title: 'Password must be minimum of 8 characters');
                    }else {
                      return null;
                    }
                  },
                ...
                cwAuthProceedButton(
                  ...
                  onTap: () async {
                          final validate = model.credentialFormKey.currentState!.validate();
                            if (validate) {
                              await model.signUp(
                                context,
