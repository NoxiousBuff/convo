        ...
        body: model.isNoticationAllowed
            ? ListView(
                ...
                children: [
                  ...
                  //       hiveApi.hiveStream(HiveApi.appSettingsBoxName),
                  //   builder: (context, appSettingsBox, child) {
                  //     final isZapNotificationsAllowed = appSettingsBox
                  //         .get(AppSettingKeys.isZapAllowed, defaultValue: true);
                  //     final isLetterNotificationsAllowed = appSettingsBox.get(
                  //         AppSettingKeys.isLetterAllowed,
                  //         defaultValue: true);
                  //     final isDiscoverNotificationsAllowed = appSettingsBox.get(
                  //         AppSettingKeys.isDiscoverAllowed,
                  //         defaultValue: true);
                  //     final isSecurityNotificationsAllowed = appSettingsBox.get(
                  //         AppSettingKeys.securityNotifications,
                  //         defaultValue: true);
                  //     return Column(
                  //       crossAxisAlignment: CrossAxisAlignment.start,
                  //       children: [
                  ...
                  //                 'Discover',
                  //                 subtitle:
                  //                     'Sent when there are you found new friend to talk.',
                  //                 showTrailingIcon: false,
                  //               ),
                  //             ),
                  //             horizontalSpaceRegular,
                  ...
                  //                 'Security',
                  //                 subtitle:
                  //                     'Sent when we are secring the app so as to have complete transparency.',
                  //                 showTrailingIcon: false,
                  //               ),
                  //             ),
                  //             horizontalSpaceRegular,
