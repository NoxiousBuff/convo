...
import 'package:hint/ui/views/chat/message_bubble/messagebubble_viewmodel.dart';
...
class _MessageBubbleViewState extends State<MessageBubbleView> {
  final _swipedMsg = locator.get<GetReplyMessageValue>();
          ...
          return Column(
            children: [
              ...
              msgOptionsWidget(
                ...
                onTap: () {
                  setState(() {
                    _swipedMsg.getSwipedMsg(widget.message);
                    _swipedMsg.isReplyValChanger(true);
                  });
                },
              ),
